...
/* sim/mobile/src/main/src/codein.c (warn_write callback). */
/* The sim mobile validates the CRC and on a valid msg_type=0x02 */
/* (collision) prints "WARN collision ICAO=..." to ttyACM0, flashes red */
/* LED and chirps the buzzer for 5 s before auto-clearing. */
/* ===================================================================== */
...
enum ble_warning_msg_type {
	...
	/* terminal "you crashed" event. Sim mobile receives this
