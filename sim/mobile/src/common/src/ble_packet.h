...
// Proposed for SkyWatch sim-node telemetry. **Agree with William before
// either side implements.** Both sides must reference *these exact* UUIDs;
// UUIDs are how the GATT client picks the right service/characteristic.
// To register on the Zephyr/firmware side use BT_UUID_DECLARE_128() with
// BT_UUID_128_ENCODE(); see zephyr/samples/bluetooth/peripheral_nus for the
// idiom. The byte order in BT_UUID_128_ENCODE() reverses these as Zephyr
// stores UUIDs in little-endian on the wire.
#define SKYWATCH_BLE_SERVICE_UUID "4d8a4011-7f24-43c4-9c5b-a17c7af70001"
#define SKYWATCH_BLE_AIRCRAFT_UUID "4d8a4011-7f24-43c4-9c5b-a17c7af70002"
